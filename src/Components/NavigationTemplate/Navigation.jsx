...
const Navigation = () => {
  ...
  return (
    <div className={`navigation ${nav && "active"} ${DarkTheme && "dark"}`}>
      ...
      <Nav Icon={FiMessageSquare} title={"Requests"} />
      <Nav Icon={AiOutlineUsergroupAdd} title={"Clients"} />

      <div className="divider"></div>

      <Nav Icon={MdOutlineNotificationsActive} title={"Notifications"} />
      <Nav Icon={AiOutlineDollarCircle} title={"Earnings"} />
      <Nav Icon={TbFileUpload} title={"Queries"} />
      <Nav Icon={BiMessageAltAdd} title={"Client Requests"} />
