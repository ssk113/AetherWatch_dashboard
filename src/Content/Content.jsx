...
import { FaDribbble, FaGithub, FaInstagram, FaWhatsapp } from "react-icons/fa";
  ...
  return (
    <div className={`content ${DarkTheme && "dark"}`}>
      <div className="row header">
        ...
        <h1 className="txt-head">Incoming Queries</h1>
      ...
      <div className="row header">
        <Card Icon={AiOutlineUsergroupAdd} title="Clients" value="+ 0" />
        <Card Icon={RiChat3Line} title="Requests" value="+ 0" />
      ...
      <div className="row tall-square inv-bg">
        ...
        <div className="admin">
          ...
          <div className="info">
            <h2 className="admin-name">AetherWatch.</h2>
            <span className="admin-about">DNS filtering using AI-ML</span>
          </div>
